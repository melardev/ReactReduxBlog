...
# Introduction
This is a blog application built with React + Redux, it is not finished by any means, but it has some code
...
# TODO
- Header links, active or not do not work as expected
- Pagination not implemented yet
- Create articles feature
- Refactor the Notification System, make it easy
# Resources
- [Listen to history changes](https://stackoverflow.com/questions/51839183/same-component-used-in-multiple-routes-is-being-remounted-react-router)
